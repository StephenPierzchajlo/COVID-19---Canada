...
### Country List
For users of these functions, it will be useful to get a list of names of countries that can be used. This takes no arguments, and simply outputs a list of all countries the user could choose from.
```{r message=FALSE, warning=FALSE}
