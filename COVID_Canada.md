...
Now we can see how the dates are formatted as actual dates. <br/>
...
```
    ...
    ##   term           estimate std.error statistic   p.value conf.low conf.high
    ##   <chr>             <dbl>     <dbl>     <dbl>     <dbl>    <dbl>     <dbl>
    ## 1 (Intercept)      64409.      216.    299.   0.          63984.    64834.
    ## 2 poly(date, i)1  777548.     6070.    128.   1.28e-237  765595.   789500.
    ## 3 poly(date, i)2  167158.     6951.     24.0  3.73e- 68  153471.   180845.
    ## 4 poly(date, i)3  -60439.     6847.     -8.83 1.59e- 16  -73921.   -46956.
    ## 5 poly(date, i)4   22318.     6027.      3.70 2.60e-  4   10450.    34186.
    ## 6 poly(date, i)5   71974.     4777.     15.1  2.42e- 37   62569.    81380.
    ## 7 poly(date, i)6   26692.     3386.      7.88 8.77e- 14   20024.    33360.
    ## 8 poly(date, i)7  -10375.     2113.     -4.91 1.62e-  6  -14536.    -6213.
    ## 9 poly(date, i)8  -12548.     1153.    -10.9  5.33e- 23  -14818.   -10278.
...
of countries that can be used. This takes no arguments, and simply
outputs a list of all countries the user could choose from.
...
``` r
COVID_Country_Data <- function(country, province = NULL){
...
``` r
COVID_Country_Graph <- function(country, province = NULL){
